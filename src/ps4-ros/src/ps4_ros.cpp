...
public:
    ...
    void prepareData()
    {
        ...
        this->send_rightStickX = this->scale_linear * this->rightStickX; // Added by Temitayo
    }
    ...
    void publishTwistMsg() {
        ...
        if(!this->buttonTouch) {
            ...
            msg.linear.y = this->send_rightStickX; //Added by Temitayo
        }
        else{
...
private:
    ...
    /* send data */
    double send_rightStickX, send_leftStickX, send_leftStickY, send_l2, send_r2;
